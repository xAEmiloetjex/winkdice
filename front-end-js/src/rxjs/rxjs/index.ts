...
/* Re-export from ../../../observable/index.js */
export type { GlobalConfig, SubscriberOverrides } from '../observable/index.js';
export { Observable, from, config, Subscription, Subscriber, operate, UnsubscriptionError, isObservable } from '../observable/index.js';
