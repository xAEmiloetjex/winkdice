...
describe('callbackFunc and 3 args', () => {
    const fa3cb0 = (e, f, g, cb) => {
        cb();
    };
    const fa3cb1 = (e, f, g, cb) => {
        cb(a);
    };
    const fa3cb2 = (e, f, g, cb) => {
        cb(a, b);
    };
    const fa3cb3 = (e, f, g, cb) => {
        cb(a, b, c);
    };
    const fa3cb4 = (e, f, g, cb) => {
        cb(a, b, c, d);
    };
    it('should accept cb 0 param', () => {
...
describe('callbackFunc and 4 args', () => {
    const fa4cb0 = (e, f, g, a, cb) => {
        cb();
    };
    const fa4cb1 = (e, f, g, a, cb) => {
        cb(a);
    };
    const fa4cb2 = (e, f, g, a, cb) => {
        cb(a, b);
    };
    const fa4cb3 = (e, f, g, a, cb) => {
        cb(a, b, c);
    };
    const fa4cb4 = (e, f, g, a, cb) => {
        cb(a, b, c, d);
    };
    it('should accept cb 0 param', () => {
...
describe('callbackFunc and 5 args', () => {
    const fa5cb0 = (e, f, g, a, b, cb) => {
        cb();
    };
    const fa5cb1 = (e, f, g, a, b, cb) => {
        cb(a);
    };
    const fa5cb2 = (e, f, g, a, b, cb) => {
        cb(a, b);
    };
    const fa5cb3 = (e, f, g, a, b, cb) => {
        cb(a, b, c);
    };
    const fa5cb4 = (e, f, g, a, b, cb) => {
        cb(a, b, c, d);
    };
    it('should accept cb 0 param', () => {
...
describe('callbackFunc overkill', () => {
    it('should accept 10 args and 5 params', () => {
        const fa10cb5 = (_1, _2, _3, _4, _5, _6, _7, _8, _9, _10, cb) => {
            cb(11, 12, 13, 14, 15);
        };
