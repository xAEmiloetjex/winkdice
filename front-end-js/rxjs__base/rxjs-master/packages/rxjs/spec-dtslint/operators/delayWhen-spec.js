...
it('should infer correctly', () => {
    ...
    const p = of(1, 2, 3).pipe(delayWhen((value, index) => of('a', 'b', 'c'))); // $ExpectType Observable<number>
});
...
it('should enforce types of delayDurationSelector', () => {
    ...
    const p = of(1, 2, 3).pipe(delayWhen((value, index) => of('a', 'b', 'c'))); // $ExpectError
    const q = of(1, 2, 3).pipe(delayWhen((value, index) => of('a', 'b', 'c'))); // $ExpectError
});
