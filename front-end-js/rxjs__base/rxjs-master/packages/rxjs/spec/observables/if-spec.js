...
describe('iif', () => {
    ...
    it('should accept resolved promise as thenSource', (done) => {
        const expected = 42;
        const e1 = iif(() => true, new Promise((resolve) => {
            resolve(expected);
        }), of());
        e1.subscribe({
            next: (x) => {
    ...
    it('should accept resolved promise as elseSource', (done) => {
        const expected = 42;
        const e1 = iif(() => false, of('a'), new Promise((resolve) => {
            resolve(expected);
        }));
        e1.subscribe({
            next: (x) => {
    ...
    it('should accept rejected promise as elseSource', (done) => {
        const expected = 42;
        const e1 = iif(() => false, of('a'), new Promise((resolve, reject) => {
            reject(expected);
        }));
        e1.subscribe({
            next: (x) => {
    ...
    it('should accept rejected promise as thenSource', (done) => {
        const expected = 42;
        const e1 = iif(() => true, new Promise((resolve, reject) => {
            reject(expected);
        }), of());
        e1.subscribe({
            next: (x) => {
