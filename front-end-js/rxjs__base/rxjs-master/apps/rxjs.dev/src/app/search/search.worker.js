...
const customLunr = function (config) {
...
function handleMessage(message) {
    ...
    switch (type) {
        case 'load-index':
            makeRequest(SEARCH_TERMS_URL, (encodedPages) => {
...
// indexed
function loadIndex({ dictionary, pages }) {
...
function decodePage(encodedPage, dictionary) {
    return {
        ...encodedPage,
