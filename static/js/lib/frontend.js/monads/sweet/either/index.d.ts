...
declare class EitherConstructor<L, R, T extends EitherType = EitherType> implements AsyncMonad<R>, Alternative<T>, Container<R>, Catamorphism<[L, R]> {
    ...
    fold<C>(mapLeft: (l: L) => C, mapRight: (r: R) => C): C;
...
export declare const isEither: <L, R>(value: unknown | Either<L, R>) => value is Either<L, R>;
export {};
