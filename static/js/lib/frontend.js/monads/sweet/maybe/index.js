...
export default class MaybeConstructor {
    ...
    static fromNullable(v) {
        return v != null ? MaybeConstructor.just(v) : MaybeConstructor.none();
    }
    static _noneInstance;
    static none() {
        if (MaybeConstructor._noneInstance === undefined) {
            MaybeConstructor._noneInstance = new MaybeConstructor("None" /* MaybeState.None */, undefined);
        }
    ...
    fold(mapNone, mapJust) {
        return this.isJust() ? mapJust(this.value) : mapNone(undefined);
    }
