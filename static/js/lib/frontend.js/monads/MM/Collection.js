...
export class Collection {
     ...
     */
    filterNot(filter) {
        return this.filter((value) => !filter(value));
    }
    /**
    ...
    foldRight(initialValue) {
        return (op) => this.reverse.foldLeft(initialValue)(op);
    }
    /**
    ...
    get sum() {
        ...
        return this.tail.foldLeft(first)((s, v) => s + v); //any is to trick the compiler
    }
    /**
