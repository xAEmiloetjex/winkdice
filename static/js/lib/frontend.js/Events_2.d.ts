import { EventQueue, TEvHandler, IRemLOpts, HandlerItem } from "./core/EventQueue_2_1.js";
/**
...
export declare class EventEmitter extends EventQueue {
     ...
     * Emit an event
     */
    emit(id: string, ..._data: any | any[]): Promise<import("./core/EventQueue_2_1.js").EmitState>;
}
export declare const EventEmitter2: typeof EventEmitter;
