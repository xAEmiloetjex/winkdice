...
export async function applyTheme() {
    if (localStorage.getItem("theme_theme") == null) localStorage.setItem("theme_theme", "auto")
    if (localStorage.getItem("theme_colorscheme") == null) localStorage.setItem("theme_colorscheme", "default")
